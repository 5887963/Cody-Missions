...
for "_i" from 1 to 5 do {_unit addItemToVest "UK3CB_BAF_20Rnd";};
for "_i" from 1 to 2 do {_unit addItemToVest "UK3CB_BAF_20Rnd_T";};
_unit addItemToVest "UK3CB_BAF_17Rnd_9mm";
