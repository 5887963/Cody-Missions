...
// Backpacks
_bagsmall = "TRYK_Winter_pack";				// carries 120, weighs 20
_bagmedium = "TRYK_Winter_pack";			// carries 240, weighs 30
_baglarge =  "TRYK_B_Carryall_wh"; 			// carries 320, weighs 40
_medbag = "TRYK_B_Medbag_ucp";
...
_baseUniform = ["TRYK_U_B_PCUHsW6"];
_baseHelmet = ["TRYK_H_Helmet_Snow"];
_baseGlasses = [];

// Armoured vests
_lightRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_camo","V_TacVest_oli"];
_mediumRig = ["TRYK_V_ArmorVest_Winter"]; 	// default for all infantry classes
...
// LOADOUT: SQUAD LEADER
	...
	{
		// Helmet
		_unit addHeadgear "TRYK_H_Helmet_Winter_2";
		...
		// Uniform Gear
		for "_i" from 1 to 6 do {this addItemToUniform _bandages;};
		...
		for "_i" from 1 to 1 do {this addItemToUniform _shortrangeradio;};
		...
		for "_i" from 1 to 2 do {this addItemToVest _bandages;};
		...
		(unitBackpack _unit) additemCargoGlobal [_glsmokewhite, 5];
		(unitBackpack _unit) additemCargoGlobal [_glsmokered, 5];
		(unitBackpack _unit) additemCargoGlobal [_glflarered, 5];
		(unitBackpack _unit) additemCargoGlobal [_smokegrenade, 5];
...
// LOADOUT: RIFLEMAN
	case "r":
	{
		...
		(unitBackpack _unit) additemCargoGlobal [_smokegrenade, 2];
		(unitBackpack _unit) additemCargoGlobal [_bandages, 2];
	};
...
// LOADOUT: MEDIUM MG ASSISTANT GUNNER
	case "mmgag":
	{
		...
		(unitBackpack _unit) additemCargoGlobal [_irstrobe, 1];
		(unitBackpack _unit) additemCargoGlobal [_mediumrangeradio, 1];
	};
...
// LOADOUT: HEAVY MG ASSISTANT GUNNER
	case "hmgag":
	{
		...
		for "_i" from 1 to 8 do {this addItemToUniform _bandages;};
		for "_i" from 1 to 2 do {this addItemToUniform _morphine;};
		for "_i" from 1 to 1 do {this addItemToUniform _pistolmag;};
		for "_i" from 1 to 2 do {this addItemToUniform _Mgrenade;};
		for "_i" from 1 to 1 do {this addItemToUniform _smokegrenade;};
		for "_i" from 1 to 1 do {this addItemToUniform _shortrangeradio;};
