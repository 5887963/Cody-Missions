...
f_radios_settings_acre2_longRange = ["co", "dc", "fac", "mmgag","hmgag","matag","hatag", "mcc", "tr", "mtrag","msamag", "vc", "pp", "pcc"];
...
f_radios_settings_acre2_extraRadios = ["fac", "pp", "pcc", "vc", "mcc", "tr"];
...
f_radios_settings_acre2_groups_blufor = ["Plt Net 1","Convoy","Mechanised","Tank","Air"];
f_radios_settings_acre2_groups_opfor = ["Plt Net 1","Convoy","Mechanised","Tank","Air"];
f_radios_settings_acre2_groups_indfor = ["Plt Net 1","Convoy","Mechanised","Tank","Air"];
