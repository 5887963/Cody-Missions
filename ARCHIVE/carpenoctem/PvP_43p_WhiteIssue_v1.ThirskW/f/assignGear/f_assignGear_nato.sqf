...
_scope3 = "RH_eotech553";		// Eotech 553 - 1x
_scope4 = "RH_eotexps3";		// Eotech EXPS3 - 1x
_scope5 = "RH_ta31rmr_2D";		// Acog Ta31F RMR 2D - 1x & 8x
...
// Rifle (Asst. Automatic Rifleman - MMG Asst. Gunner - MAT Asst. Gunner - Rifleman - Trainer - MCC GM - Commander)
...
// Handheld Radios
_shortrangeradio = "tf_rf7800str";
_mediumrangeradio = "tf_anprc152";
...
// Backpacks
_baglongrangeradio = "tf_rt1523g";
_baglongrangeradiomedium = "tf_rt1523g_sage";
_baglongrangeradiobig = "tf_rt1523g_big";
...
_baseUniform = ["TRYK_U_nohoodPcu_gry"];
_baseHelmet = ["H_HelmetB_light","H_HelmetB"];
_baseGlasses = [];

// Armoured vests
_lightRig = ["V_TacVest_blk","V_TacVest_brn","V_TacVest_camo","V_TacVest_oli"];
_mediumRig = ["TRYK_V_ArmorVest_rgr2"]; 	// default for all infantry classes
...
// LOADOUT: SQUAD LEADER
	case "dc":
	{
		...
		_unit addVest "TRYK_V_ArmorVest_rgr2";
		
		_unit addmagazines [_glriflemag_tr,1];
		_unit addmagazines [_glmag,1];
		_unit addweapon _glrifle;				// M16A4 M203, loaded
		...
		_unit addBackpack TRYK_B_Kitbag_Base;	// Backpack gear
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		_unit addweapon _carbine;				// M4 RIS, loaded
...
// LOADOUT: FIRE TEAM LEADER
	case "ftl":
	{
		...
		_unit addItemToVest _glriflemag_tr;		// Vest gear
		_unit addItemToVest _glriflemag_tr;
		_unit addItemToVest _glriflemag_tr;
		_unit addItemToVest _glriflemag_tr;
		_unit addItemToVest _glriflemag_tr;
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
		...
		_unit addweapon _AR;					// M249 PIP, loaded
...
// LOADOUT: ASSISTANT AUTOMATIC RIFLEMAN
	case "aar":
	{
		...
		_unit addItemToVest _riflemag_tr;			// Vest gear
		...
		(unitBackpack _unit) additemCargoGlobal [_riflemag_tr, 10];
...
// LOADOUT: RIFLEMAN (AT)
	case "rat":
	{
		...
		_unit addweapon _RAT;					// AT4, loaded
		...
		_unit addItemToVest _carbinemag_tr;		// Vest gear
		_unit addItemToVest _carbinemag_tr;
		_unit addItemToVest _carbinemag_tr;
		_unit addItemToVest _carbinemag_tr;
		_unit addItemToVest _carbinemag_tr;
...
// LOADOUT: RIFLEMAN
	case "r":
	{
		...
		(unitBackpack _unit) additemCargoGlobal [_riflemag_tr, 8];
	};
...
// LOADOUT: MEDIUM MG GUNNER
	case "mmgg":
	{
		...
		_unit addweapon _MMG;					// M60E4, loaded
...
// LOADOUT: MEDIUM MG GRENADIER
	case "mmggr":
	{
		...
		_unit addmagazines [_glmag,1];
		_unit addweapon _glcarbine;				// M4 RIS M203, loaded
...
// LOADOUT: VEHICLE DRIVER
	...
	_unit addItem "ItemGPS";				// Special equipment
	_unit assignItem "ItemGPS";
...
// LOADOUT: ENGINEER (DEMO)
	...
	{
        _unit addmagazines [_carbinemag,1];
		_unit addweapon _carbine;					// M16A4, loaded
...
// CARGO: CAR - room for 10 weapons and 50 cargo items
	case "v_car":
	{
		...
		_unit addItemCargoGlobal [_epipen, 10];
		_unit addItemCargoGlobal [_bloodbag, 5];
	};
...
// CRATE: Medium, ammo for 1 squad
	case "crate_med":
	{
		...
		_unit addItemCargoGlobal [_bandages, 50];
