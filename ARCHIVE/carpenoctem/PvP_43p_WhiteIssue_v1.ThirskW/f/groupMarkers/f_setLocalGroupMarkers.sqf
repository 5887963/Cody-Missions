...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		...
		["GrpNATO_T1", 0, "T1", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_T2", 0, "T2", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_T3", 0, "T3", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_T4", 0, "T4", "ColorBlack"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_TH1",  9, "Nightbird 1", "ColorRed"] spawn f_fnc_localGroupMarker;
 		...
 		["GrpNATO_TH3",  9, "Hermes 1", "ColorBlue"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH4",  9, "Hermes 2", "ColorBlue"] spawn f_fnc_localGroupMarker;
 		["GrpNATO_TH5",  9, "Viking 1", "ColorGreen"] spawn f_fnc_localGroupMarker;
  		["GrpNATO_TH6",  9, "Viking 2", "ColorGreen"] spawn f_fnc_localGroupMarker;
   		["GrpNATO_TH7",  9, "Eagle 1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_TH8",  9, "Eagle 2", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpNATO_AH1",  9, "Havoc 1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_AH2",  9, "Havoc 2", "ColorOrange"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["GrpAAF_IFV8",  7, "IFV8", "ColorOrange"] spawn f_fnc_localGroupMarker;
 		...
 		["GrpAAF_TNK1",  8, "Ares 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_TNK2",  8, "Ares 2", "ColorRed"] spawn f_fnc_localGroupMarker;

		["GrpAAF_TH1",  9, "Hermes 1", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpAAF_TH2",  9, "Hermes 2", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpAAF_TH3",  9, "TH3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_TH4",  9, "TH4", "ColorOrange"] spawn f_fnc_localGroupMarker;

		["GrpAAF_AH1",  9, "Apollo 1", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_AH2",  9, "Apollo 2", "ColorRed"] spawn f_fnc_localGroupMarker;
