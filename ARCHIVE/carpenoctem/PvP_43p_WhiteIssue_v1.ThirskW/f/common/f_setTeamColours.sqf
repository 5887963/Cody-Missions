...
if( (count (units (group _unit))) != 6 ) exitWith {};
...
{
	if((["_AR", format ["%1", vehicle _x]] call BIS_fnc_inString) || (["_AT2", format ["%1", vehicle _x]] call BIS_fnc_inString) || (["_AAR", format ["%1", vehicle _x]] call BIS_fnc_inString)) then
	{
		_x assignTeam "RED";
	}
	else
