...
// Markers seen by players in NATO slots.
	...
	case "blu_f":
	{
		["GrpNATO_CO", 0, "HQ", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpNATO_DC", 0, "DC", "ColorBlack"] spawn f_fnc_localGroupMarker;

		["GrpNATO_ASL", 0, "ASL", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpNATO_A", 1, "Alpha", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_B", 1, "Bravo", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpNATO_C", 1, "Charlie", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpNATO_C2", 1, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpNATO_C3", 1, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_DSL", 0, "DSL", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_D", 1, "Delta", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_D2", 1, "D2", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpNATO_D3", 1, "D3", "ColorYellow"] spawn f_fnc_localGroupMarker;
		
		["GrpNATO_ESL", 0, "ESL", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_E", 1, "Echo", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_E2", 1, "E2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpNATO_E3", 1, "E3", "ColorOrange"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in FIA slots.
	...
	case "blu_g_f":
	{
		["GrpFIA_CO", 0, "HQ", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpFIA_DC", 0, "DC", "ColorBlack"] spawn f_fnc_localGroupMarker;

		["GrpFIA_ASL", 0, "ASL", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpFIA_A", 1, "Alpha", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpFIA_B", 1, "Bravo", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpFIA_C", 1, "Charlie", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpFIA_C2", 1, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpFIA_C3", 1, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpFIA_DSL", 0, "DSL", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpFIA_D", 1, "Delta", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpFIA_D2", 1, "D2", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpFIA_D3", 1, "D3", "ColorYellow"] spawn f_fnc_localGroupMarker;
		
		["GrpFIA_ESL", 0, "ESL", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpFIA_E", 1, "Echo", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpFIA_E2", 1, "E2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpFIA_E3", 1, "E3", "ColorOrange"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		["GrpCSAT_CO", 0, "HQ", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_DC", 0, "DC", "ColorBlack"] spawn f_fnc_localGroupMarker;

		["GrpCSAT_ASL", 0, "ASL", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_A", 1, "Alpha", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_B", 1, "Bravo", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpCSAT_C", 1, "Charlie", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_C2", 1, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_C3", 1, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpCSAT_DSL", 0, "DSL", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_D", 1, "Delta", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_D2", 1, "D2", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_D3", 1, "D3", "ColorYellow"] spawn f_fnc_localGroupMarker;
		
		["GrpCSAT_ESL", 0, "ESL", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_E", 1, "Echo", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_E2", 1, "E2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpCSAT_E3", 1, "E3", "ColorOrange"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		["GrpAAF_CO", 0, "HQ", "ColorBlack"] spawn f_fnc_localGroupMarker;
		["GrpAAF_DC", 0, "DC", "ColorBlack"] spawn f_fnc_localGroupMarker;

		["GrpAAF_ASL", 0, "ASL", "ColorRed"] spawn f_fnc_localGroupMarker;
		["GrpAAF_A", 1, "Alpha", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpAAF_B", 1, "Bravo", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpAAF_C", 1, "Charlie", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_C2", 1, "C2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_C3", 1, "C3", "ColorGreen"] spawn f_fnc_localGroupMarker;
		
		["GrpAAF_DSL", 0, "DSL", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpAAF_D", 1, "Delta", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpAAF_D2", 1, "D2", "ColorYellow"] spawn f_fnc_localGroupMarker;
		["GrpAAF_D3", 1, "D3", "ColorYellow"] spawn f_fnc_localGroupMarker;
		
		["GrpAAF_ESL", 0, "ESL", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpAAF_E", 1, "Echo", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpAAF_E2", 1, "E2", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpAAF_E3", 1, "E3", "ColorOrange"] spawn f_fnc_localGroupMarker;
